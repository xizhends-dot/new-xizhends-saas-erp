...
final class OrderPageConfigRegistry
{
    ...
    public function filterFieldsFor(string $platform): array
    {
        ...
        $fields = [
            ...
            ['key' => 'item_id', 'label' => 'ItemId查询', 'type' => 'text', 'section' => 'basic', 'views' => ['platform', 'purchase', 'jp']],
            ...
            ['key' => 'receipt_city', 'label' => '国内签收地', 'type' => 'select', 'optionsKey' => 'receiptCityOptions', 'section' => 'basic', 'views' => ['platform', 'purchase']],
            ...
            ['key' => 'page_size', 'label' => '每页显示', 'type' => 'select', 'section' => 'control', 'views' => ['platform', 'purchase', 'jp'], 'options' => [
                ['value' => '100', 'label' => '100'],
                ['value' => '200', 'label' => '200'],
                ['value' => '500', 'label' => '500'],
                ['value' => '1000', 'label' => '1000'],
            ]],
            ['key' => 'customer_name', 'label' => '客人姓名', 'type' => 'text', 'section' => 'advanced', 'views' => ['platform']],
            ['key' => 'phone', 'label' => '客人电话', 'type' => 'text', 'section' => 'advanced', 'views' => ['platform']],
            ['key' => 'mail', 'label' => '客人邮箱', 'type' => 'text', 'section' => 'advanced', 'views' => ['platform']],
