...
<aside class="sidebar">
    ...
    <nav class="nav">
        ...
        <?php if ($featureEnabled('management.settings') && $canAny(['公司设置', '系统设置'])): ?><a class="<?= ($active ?? '') === 'receipt_city' ? 'active' : '' ?>" href="/settings?tenant=<?= e($tenantKey) ?>#logistics">签收地</a><?php endif; ?>
