<div class="page-head">
    <div>
        <h1>采购业绩统计 <span class="sub">参考 caigou_stats</span></h1>
    </div>
...
<section class="grid two-col">
    <div class="panel">
        <div class="panel-head"><span>采购员统计</span><span class="sub">共 <?= e($stats['total']) ?> 件</span></div>
    ...
    <div class="panel">
        <div class="panel-head"><span>完成状态分布</span><span class="sub">按 order_items.purchase_status</span></div>
        <div class="panel-body">
            <table class="table">
