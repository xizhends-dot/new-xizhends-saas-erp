                        ...
                        <div class="image-upload-area">
                            ...
                            <?php if ($canUploadImage || ($canDeleteImage && $mainImage !== '')): ?>
                                <div class="drawer-image-controls">
                                    ...
                                    <textarea form="<?= e($mainImageFormId) ?>" name="base64_image" rows="2" placeholder="可将图片粘贴到此"></textarea>
                                    <?php endif; ?>
                        ...
                        <div class="image-upload-area">
                            ...
                            <?php if ($canUploadImage || ($canDeleteImage && $skuImage !== '')): ?>
                                <div class="drawer-image-controls">
                                    ...
                                    <textarea form="<?= e($skuImageFormId) ?>" name="base64_image" rows="2" placeholder="可将图片粘贴到此"></textarea>
                                    <?php endif; ?>
                                    <div class="drawer-image-actions">
                                        <?php if ($canUploadImage): ?>
